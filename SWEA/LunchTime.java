...
public class LunchTime {
	...
	private static void solve(int depth, int m, boolean[] visited) {
		if(depth == m) {
			System.out.println("���հ��: "+ Arrays.toString(visited));
			count(visited);
			return;
		}
...
//			System.out.println("���� ��ܿ� "+ stair1.size()+ "�� �ִ�.");
			if(stair1.size() < 3) {
				tmp.t+=(1+st1.t);
				stair1.add(tmp.t);
//				System.out.println("x:"+tmp.x+" y:"+tmp.y+" ����� ���ö��� �ð��� :" +tmp.t);
			}
			else { // ��� �� á����
...
//			System.out.println("���� ��ܿ� "+ stair2.size()+ "�� �ִ�.");
